...
(function($){
	...
	$.event.special.mousewheel || document.write('<script src="../../css/addons/scrollbar/'+_dlp+'/cdnjs.cloudflare.com/ajax/libs/jquery-mousewheel/3.0.6/jquery.mousewheel.min.js"><\/script>');
	/*plugin fn*/
